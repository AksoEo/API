...
INSERT INTO `codeholders` VALUES (2,'human','test','teeest','$2b$12$dEvwKG4oznSwcmu9kWzws.61JyzlLTrYkR9ojbeRlmweIgHI9lCBG',1556796849,_binary '\�jb�!\�#F˦��?-�','mia@tejo.org',1,NULL,NULL,NULL,0,NULL),(3,'org','tejo','xxtejo',NULL,NULL,NULL,'admin@akso.org',1,NULL,NULL,'+31104361044',0,NULL);
...
INSERT INTO `codeholders_hist_password` VALUES (1,3,1555078723,'ch:3','Memfarita ŝanĝo'),(2,3,1556362593,'ch:3','Memfarita ŝanĝo'),(3,2,1556796369,'ch:2','Memfarita ŝanĝo');
...
-- Dump completed on 2019-05-03 12:13:56
