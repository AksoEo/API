...
--
-- Dumping data for table `addressLabelTemplates`
--

LOCK TABLES `addressLabelTemplates` WRITE;
/*!40000 ALTER TABLE `addressLabelTemplates` DISABLE KEYS */;
INSERT INTO `addressLabelTemplates` VALUES (1,'Testpapero','A4','{\"top\": 72, \"left\": 72, \"right\": 72, \"bottom\": 72}',2,5,72,72,8,12,0);
/*!40000 ALTER TABLE `addressLabelTemplates` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `codeholderRoles_codeholders` VALUES (1,1571734894,NULL,14,2),(2,1571735719,NULL,1,3),(3,NULL,NULL,3,22),(4,NULL,NULL,4,6),(5,NULL,NULL,4,31);
...
INSERT INTO `congresses_instances_participants` VALUES (3,_binary 'gH�#R�FT\�',NULL,0,NULL,NULL,1000,NULL),(3,_binary '��o\�@zjPt�',NULL,0,NULL,NULL,1000,NULL),(3,_binary '�%��m(�E�\�',NULL,0,NULL,NULL,1000,NULL),(3,_binary '\�\�\Z��VZ\'\\�',NULL,0,NULL,NULL,1000,NULL);
...
INSERT INTO `congresses_instances_programs_tags` VALUES (3,1);
...
INSERT INTO `forms_data` VALUES (11,_binary 'gH�#R�FT\�',1579195149,1583343854),(11,_binary '��o\�@zjPt�',1579195087,NULL),(11,_binary '�%��m(�E�\�',1579195049,NULL),(11,_binary '\�\�\Z��VZ\'\\�',1579120173,NULL);
...
INSERT INTO `forms_data_fields_boolean` VALUES (11,'tos',_binary 'gH�#R�FT\�',1),(11,'tos',_binary '��o\�@zjPt�',1),(11,'tos',_binary '�%��m(�E�\�',1),(11,'tos',_binary '\�\�\Z��VZ\'\\�',1);
...
INSERT INTO `forms_data_fields_boolean_table` VALUES (11,'manĝoj',_binary 'gH�#R�FT\�','[[null, false], [false, true]]'),(11,'manĝoj',_binary '��o\�@zjPt�','[[null, true], [false, true]]'),(11,'manĝoj',_binary '�%��m(�E�\�','[[null, true], [false, true]]'),(11,'manĝoj',_binary '\�\�\Z��VZ\'\\�','[[null, true], [false, true]]');
...
INSERT INTO `forms_data_fields_date` VALUES (11,'birthdate',_binary '\�\�\Z��VZ\'\\�','1998-09-05'),(11,'birthdate',_binary 'gH�#R�FT\�','1999-09-05'),(11,'birthdate',_binary '��o\�@zjPt�','1999-09-05'),(11,'birthdate',_binary '�%��m(�E�\�','1999-09-05');
...
INSERT INTO `forms_data_fields_enum` VALUES (11,'manĝo',_binary 'gH�#R�FT\�','vegan'),(11,'manĝo',_binary '��o\�@zjPt�','vegetarian'),(11,'manĝo',_binary '�%��m(�E�\�','vegetarian'),(11,'manĝo',_binary '\�\�\Z��VZ\'\\�','vegetarian');
...
INSERT INTO `forms_data_fields_money` VALUES (11,'money',_binary 'gH�#R�FT\�',2001),(11,'money',_binary '��o\�@zjPt�',2001),(11,'money',_binary '�%��m(�E�\�',2001),(11,'money',_binary '\�\�\Z��VZ\'\\�',2001);
...
INSERT INTO `forms_data_fields_number` VALUES (11,'cake',_binary 'gH�#R�FT\�',20),(11,'cake',_binary '��o\�@zjPt�',20),(11,'cake',_binary '�%��m(�E�\�',20),(11,'cake',_binary '\�\�\Z��VZ\'\\�',20);
...
INSERT INTO `forms_data_fields_text` VALUES (11,'email',_binary 'gH�#R�FT\�','somethingelse@something.com'),(11,'email',_binary '��o\�@zjPt�','somethingelse@something.com'),(11,'email',_binary '�%��m(�E�\�','something@something.com'),(11,'email',_binary '\�\�\Z��VZ\'\\�','something@something.com');
...
INSERT INTO `forms_data_fields_time` VALUES (11,'alvenhoro',_binary '\�\�\Z��VZ\'\\�','10:30:00'),(11,'alvenhoro',_binary '��o\�@zjPt�','11:30:00'),(11,'alvenhoro',_binary '�%��m(�E�\�','11:30:00'),(11,'alvenhoro',_binary 'gH�#R�FT\�','12:30:00');
...
INSERT INTO `forms_fields` VALUES (11,'tos','boolean'),(11,'manĝoj','boolean_table'),(11,'birthdate','date'),(11,'manĝo','enum'),(11,'money','money'),(11,'cake','number'),(11,'email','text'),(11,'alvenhoro','time');
...
INSERT INTO `registration_entries` VALUES (_binary '�ś\�\�$\�\'6Q\r��y',2021,'succeeded',NULL,NULL,0,NULL,1613755679,1613755789,NULL,'DKK'),(_binary '��\"�v\�R�\Z�\rp�',2021,'succeeded',NULL,NULL,0,39,1613755059,1613755461,NULL,'DKK'),(_binary '\�\"\�gI\0��\�\�]\�v\'',2021,'succeeded','fishy_data','codeholderData.addressAndFeeCountries',1,NULL,1613753677,1613754179,NULL,'DKK');
...
INSERT INTO `registration_entries_codeholderData_id` VALUES (_binary '�ś\�\�$\�\'6Q\r��y',39);
...
INSERT INTO `registration_entries_codeholderData_obj` VALUES (_binary '��\"�v\�R�\Z�\rp�','fr','','PARIS','','8 Rue des Étoiles','75008','','fr','newtest@test.com',NULL,'Tim',NULL,'Marley',NULL,'1938-04-17',NULL),(_binary '\�\"\�gI\0��\�\�]\�v\'','fr','','PARIS','','8 Rue des Étoiles','75008','','fr','newtest@test.com',NULL,'Tim',NULL,'Marley',NULL,'1938-04-17',NULL);
...
INSERT INTO `registration_entries_offers` VALUES (_binary '�ś\�\�$\�\'6Q\r��y',0,'membership',28000,7),(_binary '��\"�v\�R�\Z�\rp�',0,'membership',28000,6),(_binary '\�\"\�gI\0��\�\�]\�v\'',0,'membership',28000,6);
...
INSERT INTO `registration_options_offerGroups` VALUES (2021,0,'Membrokategorioj','Tie ĉi eblas elekti en kiu kategorio vi volas membri.'),(2021,1,'Donacoj','Se vi havas la necesajn resursojn por donaci al la celoj de UEA kaj TEJO, ni estus aparte dankemaj.');
...
INSERT INTO `votes_voters` VALUES (1,2,1,NULL,NULL),(2,2,1,NULL,NULL),(2,3,1,NULL,NULL),(2,4,1,NULL,NULL),(2,5,1,NULL,NULL),(2,6,1,NULL,NULL),(2,8,1,NULL,NULL),(2,18,1,NULL,NULL),(2,20,1,NULL,NULL),(2,21,1,NULL,NULL),(2,22,1,NULL,NULL),(2,23,1,NULL,NULL),(2,24,1,NULL,NULL),(2,25,1,NULL,NULL),(2,26,1,NULL,NULL),(2,27,1,NULL,NULL),(2,28,1,NULL,NULL),(2,29,1,NULL,NULL),(2,30,1,NULL,NULL),(2,31,1,NULL,NULL),(2,32,1,NULL,NULL),(2,34,1,NULL,NULL),(2,35,1,NULL,NULL),(2,36,1,NULL,NULL);
