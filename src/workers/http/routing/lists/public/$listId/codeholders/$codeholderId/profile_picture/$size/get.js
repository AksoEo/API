...
import { getCodeholderQuery } from 'akso/workers/http/routing/lists/public/$listId/codeholders/schema';
...
export default {
	...
	run: async function run (req, res) {
		// Make sure the codeholder exists in the list
		const baseQuery = (await getCodeholderQuery(req.params.listId, req)).query;
